<?php 
	...
	function captcha($largura,$altura,$tamanho_fonte,$quantidade_letras){
		...
		$fundo = imagecolorallocate($imagem,225, 82, 96); // definindo a cor do fundo da imagem em formato rgb
		$letras = imagecolorallocate($imagem,255, 255, 255); // definindo a cor do texto da imagem em formato rgb
