...
<div class="banner-foto">
    <div class="container position-relative overflow-hidden py-4">
        <div class="py-1">
            <h3 class="titulos-paginas mb-0 cor-c2"><?= $titulo_pagina; ?></h3>
        </div>
    </div>
</div>
...
<article class="background-white">
    ...
    <?php if(array_key_exists("error", $json)): ?>
        ...
        <?php else: ?>
            ...
            <a href="noticias.php?p=<?= $p ?>&regiao=<?= $regiao_url ?>" class="bt bt-b1"><i class="fas mr-1 fa-inbox"></i> Voltar para a listagem de notícias</a>
        <?php endif; ?>
